...
class MCPManager:
    ...
    async def connect_to_server(self, server_name: str):
        ...
        try:
            ...
            await task  # Attend la fin de la tâche au lieu d'appeler __aenter__() à nouveau
    ...
    async def ensure_connection(self, server_name: str) -> bool:
        ...
        try:
            # Check if already connected by trying to get tools
    ...
    async def get_tools(self, server_name: str = None) -> List[Dict[str, Any]]:
        ...
        if server_name:
            tools = [t for t in tools if t['name'].startswith(f"{server_name}.")]
        return tools
